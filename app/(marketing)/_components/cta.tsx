      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 p-8 md:p-12 hover:shadow-2xl transition-all duration-300"
          >
            <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 transition-opacity">
            ...
            <div className="relative z-10">
              ...
              <Link href="/sign-up?role=medical">
                <Button size="lg" variant="secondary" className="w-full bg-white text-slate-900 hover:bg-slate-100 shadow-lg group-hover:scale-[1.02] transition-transform">
